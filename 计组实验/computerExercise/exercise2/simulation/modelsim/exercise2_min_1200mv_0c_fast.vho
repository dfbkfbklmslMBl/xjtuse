...
-- T1	=>  Location: PIN_10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- CLK1	=>  Location: PIN_24,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst4~combout\ = LCELL((\inst5~q\) # (\CLK1~input_o\))
...
-- Equation(s):
-- \inst7~0_combout\ = (!\inst3~q\ & (!\inst2~q\ & (!\inst~q\ & !\inst1~q\)))
