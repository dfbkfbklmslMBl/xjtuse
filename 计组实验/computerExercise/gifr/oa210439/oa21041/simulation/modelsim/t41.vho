...
ARCHITECTURE structure OF t41 IS
...
-- Equation(s):
-- \inst1~regout\ = DFFEA(!\inst~regout\, GLOBAL(\CLK1~dataout\), GLOBAL(\RST1~dataout\), , , , )
...
-- Equation(s):
-- \inst2~regout\ = DFFEA(\inst1~regout\, GLOBAL(\CLK1~dataout\), GLOBAL(\RST1~dataout\), , , , )
...
-- Equation(s):
-- \inst3~regout\ = DFFEA(\inst2~regout\, GLOBAL(\CLK1~dataout\), GLOBAL(\RST1~dataout\), , , , )
...
inst : flex10ke_lcell
-- Equation(s):
-- \inst~regout\ = DFFEA(!\inst3~regout\, GLOBAL(\CLK1~dataout\), GLOBAL(\RST1~dataout\), , , , )
